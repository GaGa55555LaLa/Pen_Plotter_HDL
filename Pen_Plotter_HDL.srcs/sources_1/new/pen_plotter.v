...
module pen_plotter(clk, reset, rx, start, collision_in, btm_stop_motor, btm_angle_15,
...
module fsm (clk, start_op, rst_op, rx_data, tell_py_start_to_send_data, data_ready, state);
