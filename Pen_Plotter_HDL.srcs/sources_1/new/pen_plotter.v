...
module pen_plotter(clk, reset, send_data_button, collision_in, btm_step, btm_dir, top_step, top_dir, 
servo_pwm, collision_out, btm_IN1, 
...
module fsm (clk, start_op, rst_op, btm_step, btm_start, btm_dir, btm_done, top_step, top_start, top_dir, top_done);
input              clk;
input              start_op, rst_op;
