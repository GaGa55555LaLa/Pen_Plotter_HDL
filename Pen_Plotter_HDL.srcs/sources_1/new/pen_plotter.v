...
parameter RESETTING_L             = 4'd1;  // å¾???žèµ° ?œª?Ž¥è§? limit switch
parameter RESETTING_R             = 4'd2;  // å¾?ä¸­å?ƒèµ° å·²æŽ¥è§? limit switch
parameter RECEIVE_TOP_DIR         = 4'd3;   // ?Ž¥?”¶ X è»¸æ–¹???
parameter SEND_TOP_DIR_COMPLETE   = 4'd4;   // ?™¼?? X è»¸æ–¹??‘æŽ¥?”¶å®Œç•¢
parameter RECEIVE_TOP_STEP        = 4'd5;   // ?Ž¥?”¶ X è»¸æ­¥?•¸
parameter SEND_TOP_STEP_COMPLETE  = 4'd6;   // ?™¼?? X è»¸æ­¥?•¸?Ž¥?”¶å®Œç•¢
parameter RECEIVE_BTM_DIR         = 4'd7;   // ?Ž¥?”¶ Y è»¸æ–¹???
parameter SEND_BTM_DIR_COMPLETE   = 4'd8;   // ?™¼?? Y è»¸æ–¹??‘æŽ¥?”¶å®Œç•¢
parameter RECEIVE_BTM_STEP        = 4'd9;   // ?Ž¥?”¶ Y è»¸æ­¥?•¸
parameter SEND_BTM_STEP_COMPLETE  = 4'd10;   // ?™¼?? Y è»¸æ­¥?•¸?Ž¥?”¶å®Œç•¢
parameter RECEIVE_SERVO_DIR       = 4'd11;   // ?Ž¥?”¶ Z è»¸ç????
parameter SEND_SERVO_DIR_COMPLETE         = 4'd12;  // ?™¼?? Z è»¸ç???‹æŽ¥?”¶å®Œç•¢
parameter WAIT_TO_STABLE          = 4'd13;  // ç­‰å?…è?Šè?Ÿç©©å®?
parameter EXECUTION               = 4'd14;  // ?Ÿ·è¡Œæ?‡ä»¤ 
parameter EXECUTION_COMPLETE      = 4'd15;  // å®Œæ?æ?‡ä»¤ä¸¦å?žå‚³
...
always@(*) begin
    case(state)
        ...
        EXECUTION_COMPLETE: begin
            // TODO: ç­‰å?…å¹¾?? cycle ??žåˆ° RECEIVE_X_DIR
