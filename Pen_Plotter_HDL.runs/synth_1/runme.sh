...
HD_PWD='C:/Users/GaGa-PC/Desktop/Tsing Hua/HardwareDesign/FinalProject/Pen_Plotter_HDL/Pen_Plotter_HDL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pen_plotter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pen_plotter.tcl
